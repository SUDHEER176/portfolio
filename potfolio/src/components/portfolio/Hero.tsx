    ...
    <section id="top" className="relative min-h-screen pt-32 pb-20 overflow-hidden bg-noise">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <a
            href="https://drive.google.com/uc?export=download&id=1XyfLeofNlnDFcrDe13M_4QtIFUB4rD7s"
            target="_blank"
          ...
          <div className="ml-auto flex items-center gap-2">
            {[
              ...
              { icon: Linkedin, href: "https://linkedin.com/in/sudheer-vasamsetti-7b7a4b291", label: "LinkedIn" },
              { icon: Mail, href: "mailto:sudhirvasamsetti2@gmail.com", label: "Email" },
